...
def test_centroid_tracking_and_velocity():
    ...
    detections_f1 = [{"bbox": [100, 100, 50, 50], "label": "car", "confidence": 0.9}]
    ...
    detections_f2 = [{"bbox": [110, 110, 50, 50], "label": "car", "confidence": 0.9}]
...
def test_centroid_tracker_disappearance():
    ...
    # Frame 1: Register
    tracker.update(
        [{"bbox": [100, 100, 50, 50], "label": "person", "confidence": 0.8}], 1, 0.0
    )
